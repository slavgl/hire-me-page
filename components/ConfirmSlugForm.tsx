  ...
  if (publishedUrl) {
    ...
    return (
      <div className="mx-auto max-w-xl space-y-8 text-center">
        ...
        <CopyLinkButton
          url={publishedUrl}
          className="w-full rounded-lg border border-neutral-300 bg-white px-6 py-3 text-base font-medium text-neutral-900 hover:bg-neutral-50 dark:border-neutral-600 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800"
        />
        <div className="space-y-4 text-left">
          <p className="text-sm font-medium text-neutral-700 dark:text-neutral-300">
            Email template
          </p>
          <pre className="whitespace-pre-wrap rounded-lg border border-neutral-200 bg-white p-4 text-xs text-neutral-800 dark:border-neutral-700 dark:bg-neutral-950 dark:text-neutral-200">
            {emailBody}
          </pre>
          <CopyLinkButton
            url={emailBody}
            label="Copy email message"
            className="rounded-md bg-white px-3 py-2 text-sm font-medium text-neutral-900 ring-1 ring-neutral-300 hover:bg-neutral-50 dark:bg-neutral-900 dark:text-neutral-100 dark:ring-neutral-600 dark:hover:bg-neutral-800"
          />
          <p className="text-sm font-medium text-neutral-700 dark:text-neutral-300">
            LinkedIn DM
          </p>
        ...
        <button
          ...
          className="text-sm font-medium text-neutral-600 underline dark:text-neutral-400 dark:hover:text-neutral-200"
        >
          Go to dashboard
        </button>
      </div>
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="min-w-0 flex-1 rounded-lg border border-neutral-300 bg-white px-3 py-2 font-mono text-sm text-neutral-900 focus:border-neutral-900 focus:outline-none focus:ring-1 focus:ring-neutral-900 dark:border-neutral-600 dark:bg-neutral-900 dark:text-neutral-100 dark:focus:border-neutral-100 dark:focus:ring-neutral-100"
            autoComplete="off"
          />
        </div>
      </div>
